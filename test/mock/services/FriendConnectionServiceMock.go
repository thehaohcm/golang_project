...
type FriendConnectionServiceMock interface {
...
type service struct {
	repository test.FriendConnectionRepositoryMock
}

func New(repo test.FriendConnectionRepositoryMock) FriendConnectionServiceMock {
	return &service{
		repository: repo,
	}
}
